...
<template>
  <div class="page">
    <div class="page-header"><span class="page-title">Explore</span></div>
    <div class="insp-empty" style="flex:1">Explore hasn't been designed yet — nothing in the design canvas covers this destination.</div>
  </div>
</template>

...
const tabs = [
  { id: "access", icon: "ph-table", label: "Access log" },
  { id: "traffic", icon: "ph-chart-line", label: "Traffic" },
];
...
<template>
  <div class="dock">
    <DockTabHeader dock-id="stream" :tabs="tabs" :model-value="store.activeStreamTab" @update:modelValue="store.setStreamTab" />

    <template v-if="store.activeStreamTab === 'access'">
      <div class="toolbar">
